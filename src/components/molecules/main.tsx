...
export const MainSection = () => (
    <>
      ...
      <section className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 flex justify-center items-center flex-col z-6 px-5 lg:px-0">
          <h1 className="font-bold text-4xl lg:text-6xl text-center text-white-700">
            Omnichain OTC Market
          </h1>

          <div
              className="mt-10 w-full max-w-lg lg:max-w-3xl py-8 px-5 text-center flex flex-col justify-center items-center border border-gray-700 rounded-3xl bg-black bg-opacity-80">
        <span className="text-gray-400 text-xl lg:text-2xl w-full">
          ...
          <span className="text-white-700">No</span> LP limits. Decentralised by
          nature.
        </span>

            <div
                className="mt-5 text-white flex flex-col lg:flex-row items-center justify-center w-full lg:w-[70%] px-10">
          ...
          <Link href={MVP} target="_blank">
            <Button
                className="rounded-2xl mt-10 w-72 p-10 lg:w-80 lg:p-7"
                variant="default"
            >
