...
export const MainSection = () => (
  <section className="relative h-screen w-full">
    ...
    <div className="absolute inset-0 flex justify-center items-center flex-col z-6 px-5 lg:px-0">
      ...
      <div className="mt-10 w-full max-w-lg lg:max-w-3xl py-8 px-5 text-center flex flex-col justify-center items-center border border-gray-700 rounded-3xl bg-black bg-opacity-80">
