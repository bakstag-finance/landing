...
export const Footer = () => (
  <div
    className={
      "flex justify-center items-center border-t border-t-[0.5] border-t-black-400 px-5 lg:px-44 p-10 w-full mt-5 lg:mt-0"
    }
  >
    <div
      className={
        "flex flex-col lg:flex-row justify-between  w-full max-w-[1200px]"
      }
    >
      ...
      <div className={"flex flex-col lg:flex-row"}>
        <div className={"flex flex-col mt-5 lg:mt-0"}>
          <span className={"text-white-700 text-4xl lg:text-2xl"}>
            Community
          </span>
          <a
            className="text-2xl lg:text-xl text-gray-600 mt-5 cursor-pointer group transition-all duration-300 ease-in-out hover:text-white-700"
